...
from apps.notification.views.notification_nnread_count_view import (
    NotificationUnreadCountView,
)
from apps.notification.views.notification_mark_all_read_view import (
...
urlpatterns = [
    ...
    path(
        "mark-read-bulk/", NotificationMarkReadBulkView.as_view(), name="mark-read-bulk"
    ),
]
