...
from apps.volunteer_army.serializers.citizen.citizen_participation_attendance_detail_serializer import CitizenParticipationAttendanceDetailSerializer


class CitizenParticipationAttendanceDetailView(RetrieveAPIView):
    serializer_class = CitizenParticipationAttendanceDetailSerializer
