...
export function PollAnalyticsSkeleton() {
  return (
      ...
      <div className="max-w-screen-2xl mx-auto px-6 py-6 space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-2">
            <div className="h-8 w-64 bg-gray-700/50 rounded-lg animate-pulse" />
            <div className="h-4 w-96 bg-gray-700/50 rounded-lg animate-pulse" />
          </div>
        ...
        <div className="h-20 w-full bg-[#1e1e1e] border border-slate-700 rounded-xl animate-pulse" />
