      ...
      <div className="max-w-screen-2xl mx-auto px-6 py-6 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-2">
            ...
            <Skeleton className="h-4 w-48 md:w-60" />  {/* Subtitle */}
          </div>
          <div className="flex gap-3">
            <Skeleton className="h-10 w-24 rounded-lg" /> {/* Refresh Button */}
            <Skeleton className="h-10 w-24 rounded-lg" /> {/* Export Button */}
          </div>
        </div>

        {/* FILTER TOOLBAR SKELETON */}
        <div className="bg-[#1e1e1e] border border-slate-700 rounded-xl p-4">
          <div className="flex flex-col md:flex-row items-center gap-4">
            <Skeleton className="h-10 w-full md:w-64" /> {/* Date Select */}
