  ...
  return (
    <div className="flex flex-col items-center my-6 px-4 text-center">
      ...
      <p className="mt-10 text-gray-700 max-w-md">
        ...
        <span className="font-bold">Reset Successfully</span>. You can now log
        in securely with your new password.
      </p>

      <p className="mt-2 text-gray-500 text-sm">
        If you didn’t make this change, please reset your password again
        immediately or contact support for help.
      </p>
