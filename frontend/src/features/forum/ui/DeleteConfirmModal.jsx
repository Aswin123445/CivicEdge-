...
/**
 * CIVICEDGE COMPONENT: DeleteConfirmModal
 * A high-visibility confirmation dialog for destructive actions.
 */
const DeleteConfirmModal = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div 
        ref={modalRef}
        className="relative bg-white w-full max-w-md rounded-2xl shadow-2xl border border-slate-200 z-10 animate-in fade-in zoom-in-95 duration-200"
      >
        <div className="p-6">
        ...
        <div className="p-4 bg-slate-50 flex flex-col-reverse sm:flex-row items-center justify-end gap-3 rounded-b-2xl border-t border-slate-100">
          <button
            ...
            onClick={onClose}
            disabled={isDeleting}
            className="w-full sm:w-auto px-6 py-2.5 text-sm font-semibold text-slate-600 hover:text-slate-900 transition-colors"
          >
            Cancel, keep it
          </button>
          <button
