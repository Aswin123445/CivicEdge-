    ...
    <header className="bg-white border-b border-slate-200 pt-12 pb-8 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <span
            className={`px-6 py-2 rounded-full bg-blue-50 border text-center border-blue-100 text-blue-700 font-bold text-sm uppercase tracking-widest ${
              STATUS_STYLES[complaint?.status?.code]
            }`}
          >
