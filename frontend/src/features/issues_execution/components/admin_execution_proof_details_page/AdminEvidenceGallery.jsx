...
const AdminEvidenceGallery = ({ proofData }) => {
  return (
    <section className="bg-[#1e1e1e] border border-slate-700 rounded-xl p-6">
      <h2 className="text-lg font-semibold mb-4">Evidence Gallery</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {proofData?.evidences.map((item) => (
          <div
            key={item.secure_url}
...
export default AdminEvidenceGallery;
