    ...
    <div className="min-h-screen bg-[#F8FAFF] animate-pulse px-4 md:px-6 lg:px-16 py-4">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-4 mb-8">
        <div className="flex flex-col lg:flex-row lg:items-center gap-4">
          ...
          {/* search */}
          <div className="h-10 w-full lg:w-80 bg-slate-300 rounded-lg"/>
          ...
          <div className="flex flex-wrap gap-3">
            {[1,2,3,4,5,6,7].map((i)=>(
              <div
                key={i}
                className="h-9 w-32 bg-slate-300 rounded-full"
              />
            ))}
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {[1,2,3,4].map((card)=>(
          <div
            key={card}
            className="bg-white border border-slate-300 rounded-xl p-6 shadow-sm"
          >
            ...
            <div className="h-3 w-40 bg-slate-300 rounded mb-6"/>
