...
import AdminPostponedVerificationActionPanel from "../components/postponed_report_page/AdminPostponedVerificationActionPanel";
const AdminPostponedReportDetailPage = () => {
  const { id } = useParams();
  const {
  ...
  if (pendingVerificationDetailLoading || contractorsLoading)
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <aside className="col-span-12 lg:col-span-4 space-y-6">
            <div className="sticky top-6 space-y-6">
              ...
              <AdminPostponedVerificationActionPanel
                openModal={openModal}
...
export default AdminPostponedReportDetailPage;
